...
import practice.ver1.dao.CustomerDao;
import practice.ver1.dto.CustomerDto;

public class Test {

	// ver.1
	// config: xml & sql(mapper): xml
	public static void main(String[] args) throws Exception {
		// mybatis 설정 파일 읽기
		Reader reader = Resources.getResourceAsReader("config/test-mybatis-config.xml");
