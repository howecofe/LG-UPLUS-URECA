...
public class BJ_치킨배달_15687_NP_memoi {
    ...
    public static void main(String[] args) throws Exception {
        ...
        memoi = new int[houseSize][srcSize]; // 집 * 치킨집
        ...
        // NP
        index = new int[srcSize]; // 치킨집 수만큼 배열 생성
        // M개만큼 뽑고 싶다. (조합)
        // 최초 index 배열은 최소를 의미 (asc로 정렬된 상태)
        for (int i = srcSize - M; i < srcSize; i++) { // 000...000111 (M: 3)
        	index[i] = 1; 
        }
